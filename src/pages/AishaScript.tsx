                  ...
                  <CardContent className="p-4 sm:p-6 pt-0 flex flex-col h-full">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mt-auto">
                      <Button
                        ...
                        className="flex-1 bg-purple-500 hover:bg-purple-600 text-white border-0 rounded-full py-3 px-4 text-sm sm:text-base font-medium"
                      >
                      ...
                      <Button
                        ...
                        variant="outline"
                        className="flex-1 border-purple-500 text-purple-600 hover:bg-purple-50 rounded-full py-3 px-4 text-sm sm:text-base font-medium"
                      >
