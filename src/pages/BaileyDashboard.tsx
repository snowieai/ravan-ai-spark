              ...
              <div className="text-center py-12 px-8">
                ...
                <div className="flex justify-center items-center gap-6 mb-12 flex-wrap">
                  <Button
                    ...
                    className="bg-purple-500 hover:bg-purple-600 text-white px-10 py-6 text-xl rounded-full shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center group border-0"
                  >
