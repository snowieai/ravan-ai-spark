...
const INFLUENCER_NAME = 'bailey';

const BaileyCalendar = () => {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('bailey-calendar-changes')
      .on(
        'postgres_changes',
        {
          event: '*',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-emerald-900">Content Calendar</h1>
              </div>
              <div className="flex items-center space-x-2 ml-8">
                ...
                <h2 className="text-lg font-semibold text-emerald-900 min-w-[140px] text-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-emerald-100">
          {/* Day Headers */}
          <div className="grid grid-cols-7 border-b border-emerald-100 bg-emerald-50">
            {dayNames.map(day => (
              <div key={day} className="p-3 text-center font-semibold text-emerald-900 text-sm">
                {day}
              </div>
            ))}
          </div>
          ...
          <div className="divide-y divide-emerald-100">
            {weeks.map((week, weekIndex) => (
              <div key={weekIndex} className="grid grid-cols-7 divide-x divide-emerald-100">
                  ...
                  return (
                    <div
                      ...
                      className={`min-h-[120px] p-2 ${
                        isCurrentMonth ? 'bg-white' : 'bg-emerald-50/30'
                      } ${isToday ? 'ring-2 ring-emerald-500 ring-inset' : ''} ${
                        isDragOver ? 'ring-2 ring-emerald-400 bg-emerald-100/50' : ''
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-1 mb-1 flex-wrap">
                                  ...
                                  {item.video_status === 'generating' && (
                                    <Badge className="text-xs px-1 py-0 bg-purple-100 text-purple-800 animate-pulse">
                                      🎬 Generating...
                                    </Badge>
                                  )}
        ...
        {/* Legend */}
        <div className="mt-6 bg-white/90 backdrop-blur-sm rounded-lg p-4 border border-emerald-100">
