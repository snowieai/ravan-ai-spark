...
const MayraCalendar = () => {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('mayra-calendar-changes')
      .on(
        'postgres_changes',
        {
          event: '*',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-amber-50 relative overflow-hidden">
      {/* Background Effects */}
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-yellow-900">Content Calendar</h1>
              </div>
              <div className="flex items-center space-x-2 ml-8">
                ...
                <h2 className="text-lg font-semibold text-yellow-900 min-w-[140px] text-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-yellow-100">
          {/* Day Headers */}
          <div className="grid grid-cols-7 border-b border-yellow-100 bg-yellow-50">
            {dayNames.map(day => (
              <div key={day} className="p-3 text-center font-semibold text-yellow-900 text-sm">
                {day}
              </div>
            ))}
          </div>
          ...
          <div className="divide-y divide-yellow-100">
            {weeks.map((week, weekIndex) => (
              <div key={weekIndex} className="grid grid-cols-7 divide-x divide-yellow-100">
                      ...
                      <div className={`text-sm font-semibold mb-1 ${
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          onClick={() => {
                            ...
                            className="h-5 w-5 p-0 text-yellow-600 hover:bg-yellow-100"
                            title="Add Content"
                          >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-1 mb-1 flex-wrap">
                                  ...
                                  {item.video_status === 'generating' && (
                                    <Badge className="text-xs px-1 py-0 bg-emerald-100 text-emerald-800 animate-pulse">
                                      🎬 Generating...
                                    </Badge>
                                  )}
        ...
        {/* Legend */}
        <div className="mt-6 bg-white/90 backdrop-blur-sm rounded-lg p-4 border border-yellow-100">
      ...
      <Dialog open={showDetailDialog} onOpenChange={setShowDetailDialog}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-white z-50">
          <DialogHeader>
            <DialogTitle className="text-xl font-bold text-yellow-900">Content Details</DialogTitle>
          </DialogHeader>
          {selectedItem && (
