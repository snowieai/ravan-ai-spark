          ...
          <div className="max-w-6xl mx-auto animate-fade-in px-4 sm:px-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
              {scriptData.scripts?.map((script, index) => (
                <Card 
                  key={index}
                  className={`bg-white/80 backdrop-blur-sm border-blue-100 transition-all duration-300 h-full cursor-default hover:shadow-2xl ${
                  ...
                  <CardContent className="p-6 pt-0 flex flex-col h-full">
                    ...
                    <div className="flex flex-col gap-3 mt-auto">
                      <Button
                        ...
                        size="lg"
                        className="w-full bg-blue-500 hover:bg-blue-600 text-white border-0 rounded-full py-4 text-base font-semibold shadow-md hover:shadow-lg transition-all"
                      >
                      ...
                      <Button
                        ...
                        variant="outline"
                        size="lg"
                        className="w-full border-2 border-blue-500 text-blue-600 hover:bg-blue-50 rounded-full py-4 text-base font-semibold transition-all"
                      >
